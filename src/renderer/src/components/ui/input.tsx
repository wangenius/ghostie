  ...
  ({ className, type, variant, onValueChange: onChange, ...props }, ref) => {
    return (
      <input
        ...
        autoComplete="off"
        className={cn(
          "flex h-10 w-full rounded-full px-4 py-2 text-sm file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground/70 focus-visible:outline-none bg-muted focus:bg-muted-foreground/10 transition disabled:cursor-not-allowed disabled:opacity-50",
          variant === "title" &&
